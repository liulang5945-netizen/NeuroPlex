...
> 与 `COMPREHENSIVE_NEURON_ARCHITECTURE_PLAN.md` 配套阅读。
...
- 架构主文档: [COMPREHENSIVE_NEURON_ARCHITECTURE_PLAN.md](COMPREHENSIVE_NEURON_ARCHITECTURE_PLAN.md)
