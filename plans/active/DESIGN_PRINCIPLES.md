...
>
> **2026-08-21 解释边界**：本文是 Legacy NeuroPlex 的设计历史，不是 Taiji 新底座实现合同。部分早期描述（例如抑制向量直接取反、外部触发新生、Transformer 树突扩展）已被后续代码或新决策取代。正式 Taiji 是顶层 TPF；新代码服从 [TAIJI_SUBSTRATE_ARCHITECTURE.md](TAIJI_SUBSTRATE_ARCHITECTURE.md) 的确定状态方程、局部学习和 N0–N10 反证门槛。
